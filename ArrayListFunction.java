...
public class ArrayListFunction {
	public static void main(String[] args) {
		...
		arrlist.add("Tharani");
		arrlist.add("Bhavitha");
		arrlist.add("Viveka");
		arrlist.add("Vignatha");
		arrlist.add("Alekhya");
		...
		boolean retval = arrlist.contains("Pooja");
		// here we are applying the if condition to check the element

		if (retval == true) {
			System.out.println("element Pooja is contained in the list");
		} else {
			System.out.println("element Pooja  is not contained in the list");//system is used to return code
